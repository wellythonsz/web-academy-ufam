...
export class Turma {
    ...
    public idEmEdicao: number | null = null; // Controla qual aluno está sendo editado na tabela
    ...
    salvarEdicao(id: number, nome: string, idade: number, altura: number, peso: number, genero: string): void {
    ...
    private atualizarDOM(): void {
        const setHtml = (id: string, texto: string) => {
